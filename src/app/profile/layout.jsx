      ...
      <motion.main
        ...
        <div className='lg:col-span-1 col-span-5 relative p-6 lg:border-l border-b max-lg:h-fit space-y-5'>
          ...
          <div className='lg:py-6 py-3 lg:border-b lg:space-y-4 space-y-2'>
            ...
            <Image src={'/student.jpg'} alt='signup' width={100} height={100} className='lg:size-24 size-20 object-cover object-top rounded-full  mx-auto' />
              {/* ring */}
            ...
            <div className='text-center space-y-0.5'>
              ...
              <p className='text-[10px] text-text-gray'>الصف الثاني/إعدادي</p>
            </div>
          </div>
          {/* menu */}
          <ProfileNavbar/>
