...
const LoginPage = () => {
  const [role, setRole] = useState ("") // القيمة الافتراضية لو حابب
          ...
          <div className='lg:w-[60%] md:w-2/3 w-4/5 mx-auto space-y-12'>
            ...
            <div className='flex items-center gap-4 justify-center'>
              <Button
                ...
                className={`px-8 h-12  bg-secondary-green text-white`}
              >
                طالب
              </Button>
              <Button
                onClick={() => setRole('student')}
                className={`px-8 h-12 bg-main-yellow text-white`}
              >
                ولي أمر
              </Button>
              <Button
                onClick={() => setRole('teacher')}
                className={`px-8 h-12 bg-main-red text-white`}
              >
                مدرس
              </Button>
            </div>
